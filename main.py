...
rBox = pygame.image.load('rBox.png')
...
buillding = pygame.image.load('buillding.png')
...
def draw_lines():
    ...
    for i in range(row_number+1):
        pygame.draw.line(screen, LINE_COLOR, (0,i*cell_size), (temp,i*cell_size),LINE_WIDTH)
    temp=np.shape(state.cells)[0]*cell_size
    for i in range(col_number+1):
        pygame.draw.line(screen, LINE_COLOR, (i*cell_size,0), (i*cell_size,temp),LINE_WIDTH)
...
def putBuillding():
    ...
    pygame.draw.rect(screen,TRUK_COLOR,(truckPosition[1]*cell_size+5,truckPosition[0]*cell_size+5,cell_size-10,cell_size-10))
...
while running:
    ...
    if done and counter>=10:
        ...
        while color>255:
            color-=255
        pygame.draw.rect(screen,(color,color2,color3),((truckPosition[1]*cell_size)+5,(truckPosition[0]*cell_size)+5,cell_size-10,cell_size-10))
